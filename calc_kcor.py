...
if __name__ == "__main__":
    ...
    ModelMag_r = []
    z_spec = []
    with open('z_amd_M_all.csv', "r", newline="") as f:
        ...
        for i in range(1,len(g_r[1:])):
            if z_spec[i] == "":
                ...
                print(float_formatter(calc_kcor(filter_name = "r", redshift = float(z_spec[i]), colour_name = "g - r", colour_value = float(g_r[i]))))
